...
//link for revrobotics libraries
  public Drivetrain() {
    ...
    m_frontLeft = new WPI_TalonSRX(RobotMap.leftFrontMotor);
    m_midLeft = new WPI_TalonSRX(RobotMap.leftMidMotor);
    m_rearLeft = new WPI_TalonSRX(RobotMap.leftBackMotor);
    ...
    m_frontRight = new WPI_TalonSRX(RobotMap.rightFrontMotor);
    m_midRight = new WPI_TalonSRX(RobotMap.rightMidMotor);
    m_rearRight = new WPI_TalonSRX(RobotMap.rightBackMotor);
    ...
    neoMotor = new CANSparkMax(RobotMap.neoBrushlessMotor, MotorType.kBrushless);
  ...
  public void sensorOutput() {
    ...
    //SmartDashboard.putData("Left Encoder Stats", leftEncoder);
    //SmartDashboard.putData("Right Encoder Stats", rightEncoder);

    SmartDashboard.putBoolean("Magnetic Limit Switch", limitSwitch.get());

    SmartDashboard.putNumber("NavX", Robot.navx.getAngle());

   /* double[] leftEncoderPorts = {leftEncoderSourceA, leftEncoderSourceB};
    double[] rightEncoderPorts = {rightEncoderSourceA, rightEncoderSourceB};

    SmartDashboard.putNumberArray("Left Encoder Ports", leftEncoderPorts);
    SmartDashboard.putNumberArray("Right Encoder Ports", rightEncoderPorts);*/
